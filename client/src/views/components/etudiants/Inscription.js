...
const Inscription = () => {
    ...
    const initialEtudiantState = {
        num_inscription_etudiant: user.num_inscription_etudiant,
        nom_etudiant: "",
        prenom_etudiant: "",
        ...
        adresse_etudiant: "",
        telephone_etudiant: "",
        email_etudiant: user.email_etudiant,
        parcours: "",
        niveau: "",
        info_cin_etudiant: {
            numero:'',
    ...
    const [currEtudiant, setCurrEtudiant] = useState(initialEtudiantState)

    const [inscription, setInscription] = useState(initialInscriptionState)
    const [currInscription, setCurrInscription] = useState(initialInscriptionState)
    ...
    //   };
      ...
      const saveInscription = () => {
        ...
        for(let key in inscription){
            if(jsonData.indexOf(key)>-1)
                formData.append(key,JSON.stringify(inscription[key]))
            else
                formData.append(key,inscription[key])
        }
        ...
        EtudiantService.update(etudiant.num_inscription_etudiant,formData)
        .then(response => {
          history.push({
      ...
      React.useEffect(() => {
          const user = JSON.parse(localStorage.getItem("user"))
          setCurrEtudiant(user)

          EtudiantService.findByIdInscription(user.num_inscription_etudiant,0)
          .then(response => {
              setCurrInscription(response.data)
...
{/*                             
                            ...
                            <CRow>
                                ...
                                <CCol>
                                    <CInputGroup className="mb-3 has-validation">
                                        ...
                                        <CFormSelect size="sm"onChange={handleInputChange} name="situation_matrimoniale_etudiant" aria-label="Default select example">
                            ...
                            <CRow>
                                ...
                                <CCol>
                                    <CInputGroup className="mb-3 has-validation">
                                        ...
                                        <CFormSelect size="sm" onChange={handleInputChange} name="sexe_etudiant" aria-label="Default select example">
                            ...
                            <CRow>
                                ...
                                <CCol>
                                    <CInputGroup className="mb-3 has-validation">
                                        ...
                                        <CFormSelect size="sm"data-parent="info_bacc_etudiant" onChange={handleInputChangeJson} aria-label="Default select example" name="serie">
                        ...
                        <CRow>
                            ...
                            <CCol>
                                <CInputGroup className="mb-3 has-validation">
                                    ...
                                    <CFormSelect size="sm"data-parent="info_bacc_etudiant" onChange={handleInputChangeJson} aria-label="Default select example" name="nature">
                        ...
                        <CRow>
                            ...
                            <CCol>
                                <CInputGroup className="mb-3 has-validation">
                                    ...
                                    <CFormSelect size="sm"data-parent="info_bacc_etudiant" onChange={handleInputChangeJson} aria-label="Default select example" name="mention">
                            ...
                            <CRow>
                                ...
                                <CCol>
                                    <CInputGroup className="mb-3 has-validation">
                                        ...
                                        <CFormSelect size="sm"onChange={handleInputChange} aria-label="Default select example" name="niveau">
                            ...
                            <CRow>
                                ...
                                <CCol>
                                    <CInputGroup className="mb-3 has-validation">
                                        ...
                                        <CFormSelect size="sm"onChange={handleInputChange} aria-label="Default select example" name="parcours">
                            ...
                            <CRow>
                                ...
                                <CCol>
                                    <CInputGroup className="mb-3 has-validation">
                                        ...
                                        <CFormSelect size="sm" onChange={handleInputChange} aria-label="Default select example" name="nationalite_etudiant">
        ...
        <CModal alignment="top" visible={visible_esec}>
            ...
            <CModalBody>
                ...
                <CInputGroup className="mb-3">
                    ...
                    <CFormSelect size="sm"onChange={handleInputChangeSec} aria-label="Default select example" name="nature">
        ...
        <CCard className="text-center mb-3">
          ...
          <div className="m-3 d-grid gap-2 col-4 mx-auto">
                <CButton onClick={saveInscription} size="lg" color="success"> <CIcon content={freeSet.cilSave} /> Faire une inscription </CButton>
            </div>
        </>
        ) : (
            <>
            <CAlert color="secondary" className="text-center mb-3">
                {!currEtudiant.statut_etudiant ? (<>
                    ...
                    <CCol className="pl-3" sm="5">  
                        <CCard>
                            <CFormLabel>
                                ...
                                />
                                <img alt=""  
                                    src={"http://localhost:8000/borderau/"+currInscription.upload_borderau} 
                                    width="350" 
                                    height="250" 
                                    className="image-preview__image" 
                                />
                    ...
                    <CCol sm="4">
                            ...
                            <CCol>
                                <CInputGroup className="mb-3">
                                    <CInputGroupText>
                                        ...
                                        type="number" name="numero" placeholder="NUMERO BORDEREAU"
                                        value={currInscription.info_borderau.numero}
                                        onChange={handleInputChangeJson2}
                                        max="7"
                                        required
                                        />
                        ...
                        <CRow>
                            ...
                            <CInputGroup>
                                ...
                                <CFormControl readOnly 
                                type="date" name="date" value={currInscription.info_borderau.date}
                                onChange={handleInputChangeJson2} />
                                </CInputGroup>
                            </CCol>
                        </CRow> <br/>
                        <CRow>
                            ...
                            <CCol>
                                <CInputGroup>
                                <CFormControl readOnly 
                                type="number" name="montant" placeholder="MONTANT" value={currInscription.info_borderau.montant}
                                onChange={handleInputChangeJson2} />
                                <CInputGroupText>
                                <span>Ariary </span>
                                </CInputGroupText>
