...
const Profile_Etudiant = () => {
    ...
    useEffect(() => {
        ...
        EtudiantService.findByIdInscription(id,0)
            .then(response => {
    ...
    //   };
      ...
      const saveInscription = () => {
        ...
        EtudiantService.validation(etudiant.num_inscription_etudiant, newEtudiant)
        .then(response => {
            history.push({
                pathname: '/personnels/inscription',
                state: { 
                  action : 'add',
        ...
        {!etudiant.statut_etudiant ? (
          ...
          <CCard className="success text-center mb-3">
                    ...
                    <CCol>
                        <CRow>
                            ...
                            <CInputGroup>
                                ...
                                <CFormControl 
                                type="text" name="num_matricule" placeholder="N° MATRICULE" value={newEtudiant.num_matricule}
                                onChange={handleInputChange} />
                            </CInputGroup>
                            </CCol>
                        </CRow>
                ...
                <CCol>
                        <CRow>
                            ...
                            <CInputGroup>
                                ...
                                <CFormControl 
                                type="text" name="num_etudiant" placeholder=" N° ETUDIANT" value={newEtudiant.num_etudiant}
                                onChange={handleInputChange} />
                            </CInputGroup>
                            </CCol>
                        </CRow>
            ...
            <div className="m-3 d-grid gap-2 col-4 mx-auto">
                <CButton onClick={saveInscription} size="lg" color="success"> <CIcon content={freeSet.cilSave} /> Valider l&apos;inscription </CButton>
            </div>
            </>
             ) : (
                <>
